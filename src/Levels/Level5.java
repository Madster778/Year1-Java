...
public class Level5 extends GameLevel {
    ...
    public Level5(Game game){
        ...
        try {
            gameMusic = new SoundClip("data/Streets Of Fire.wav");
            gameMusic.loop();
            gameMusic.setVolume(0.05);
            //System.out.println("Playing Streets of Fire");
        ...
        for (int i = 0; i < 1; i++) {
            ...
            tank = new Tank(this);
            tank.setPosition(new Vec2(randPosition, 30));
